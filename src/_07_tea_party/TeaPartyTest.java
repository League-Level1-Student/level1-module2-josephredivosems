package _07_tea_party;
	...
	public class TeaPartyTest {
		...
		public void testIsManNotKnighted() {
			TeaParty teaParty = new TeaParty();
			String greeting = teaParty.welcome("Orwell", false, false);
		...
		public void testIsManKnighted() {
			TeaParty teaParty = new TeaParty();
			String greeting = teaParty.welcome("Issac Newton", false, true);
		...
		public void testIsWomanKnighted() {
			TeaParty teaParty = new TeaParty();
			String greeting = teaParty.welcome("Laura", true, true);
